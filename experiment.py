...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        startTimes = [0.0, 0.05, 0.1, 0.2, 0.3, 0.5]
        startTime = choice(startTimes)
        endTime = startTime + 0.15
        
        thisExp.addData('TrialSceenTargetStart', startTime)
        thisExp.addData('TrialSceenTargetEnd', endTime)
